...
% Load all Rectangle ground truth masks.
%
% Syntax #####################
%
% gts = Resources.Rectangle.allGtMasks( resources_path, categories );
%
% Description ################
%
...
gt_read = @(id) imread( Resources.Rectangle.gtPath( resources_path, categories, id ) );
