...
% Plot Figure 16.
	...
	% Clear image masks since they are quite voluminous (they are saved on disk in cache_dir)
	clear masks_scrib;
	...
	disp( 'Computing GrabCut for outlines ...' );
	[ ~, ~, jaccards_out, masks_out ] = ...
		Utils.cached( fullfile( cache_dir, 'seg_out.mat' ) ...
			, @Paper.Plots.evalAllUsers ...
