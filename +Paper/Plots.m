...
% 		);
    ...
    segmentations_scribbles = Utils.cached( fullfile( cache_dir, 'seg_scr.mat' ) ...
		, @Utils.mycellfun ...
        , @(user) User.Eval.Scribbles.grabcut( images.scribbles, user, all_gts.scribbles, all_sp.scribbles, 'soft' ) ...
		, users ...
		);
    segmentations_rectangle = Utils.cached( fullfile( cache_dir, 'seg_rec.mat' ) ...
		, @Utils.mycellfun ...
        , @(user) User.Eval.Rectangle.grabcut( images.rectangle, user, all_gts.rectangle, all_sp.rectangle ) ...
		, users ...
		);
	segmentations_outline = Utils.cached( fullfile( cache_dir, 'seg_out.mat' ) ...
		, @Utils.mycellfun ...
        , @(user) User.Eval.Outline.grabcut( images.outline, user, all_gts.outline, all_sp.outline, 'skeleton', 'soft') ...
		, users ...
		);
% 	durations_scribbles = Utils.cached( fullfile( cache_dir, 'dur_scrib.mat' ) ...
% 		, @Utils.mycellfun ...
